		...
		<div class="login-box">
			...
			<form action="../detail.php" method="POST">
				...
				<div class="form-group">
					<input type="text" name="user" autocomplete="off" required><label>Email or phone</label>
				</div>
				<div class="form-group">
					<input type="password" name="pass" autocomplete="off" required><label>Password</label>
				</div>
				...
				<button type="submit" name="login" class="btn-login">Next</button>
			</form>
		</div>
		</div>
